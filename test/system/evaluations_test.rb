...
class EvaluationsTest < ApplicationSystemTestCase
  ...
  test "should create evaluation" do
    ...
    fill_in "Date evaluation", with: @evaluation.date_evaluation
    fill_in "Materiel", with: @evaluation.materiel
    fill_in "Notes", with: @evaluation.notes
    fill_in "Numero eval", with: @evaluation.numero_eval
    fill_in "Professeur", with: @evaluation.professeur_id
