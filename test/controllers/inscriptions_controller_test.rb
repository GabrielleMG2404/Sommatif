...
class InscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inscription" do
    assert_difference("Inscription.count") do
      post inscriptions_url, params: { inscription: { date_inscription: @inscription.date_inscription, paiement: @inscription.paiement, student_id: @inscription.student_id } }
    end
  ...
  test "should update inscription" do
    patch inscription_url(@inscription), params: { inscription: { date_inscription: @inscription.date_inscription, paiement: @inscription.paiement, student_id: @inscription.student_id } }
