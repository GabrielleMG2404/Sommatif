class CoursController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to cours_path, status: :see_other, notice: "Cour was successfully destroyed." }
  ...
  private
    ...
    def set_cour
      @cour = Cour.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def cour_params
      params.expect(cour: [ :nom_cours, :professeur_id, :class_room_id, :Time, :Programm_cours, :student_id ])
    end
end
