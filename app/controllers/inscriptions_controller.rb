class InscriptionsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to inscriptions_path, status: :see_other, notice: "Inscription was successfully destroyed." }
  ...
  private
    ...
    def set_inscription
      @inscription = Inscription.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def inscription_params
      params.expect(inscription: [ :date_inscription, :student_id, :paiement ])
    end
end
